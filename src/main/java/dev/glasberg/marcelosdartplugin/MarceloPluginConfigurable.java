...
public class MarceloPluginConfigurable implements Configurable {
    ...
    public boolean isModified() {
        ...
        boolean classLightThemeColorModified = !form.get_SeparatorColor_ForClasses_LightTheme_ColorPanel().equals(deserialize(config.separatorColor_ForClasses_LightTheme));
        boolean classDarkThemeColorModified = !form.get_SeparatorColor_ForClasses_DarkTheme_ColorPanel().equals(deserialize(config.separatorColor_ForClasses_DarkTheme));
    ...
    public void apply() {
        ...
        config.separatorColor_ForTestGroupCalls_DarkTheme = serialize(form.get_SeparatorColor_ForTestGroupCalls_DarkTheme_ColorPanel());
    }
    ...
    public void reset() {
        ...
        form.set_SeparatorColor_ForTestGroupCalls_DarkTheme_ColorPanel(deserialize(config.separatorColor_ForTestGroupCalls_DarkTheme));
    }
